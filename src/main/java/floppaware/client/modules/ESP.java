...
public class ESP extends Module
{
  ...
  onTick(TickEvent event)
  {
    ...
    mc.world.getEntities().forEach(e ->
    {
      if(e instanceof PlayerEntity && rPlayers.get() && e != mc.player)
        if(Floppa.friends.isFriend(e.getEntityName()))
          friends.add(e);
        else
          players.add(e);
  ...
  onRender(RenderEvent event)
  {
    ...
    {
      friends.forEach(e -> EntityUtils.setGlowing(e, Formatting.AQUA, "friends"));
      ...
      animals.forEach(e -> EntityUtils.setGlowing(e, Formatting.GREEN, "passive"));
