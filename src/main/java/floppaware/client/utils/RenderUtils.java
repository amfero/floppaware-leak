...
public class RenderUtils
{
  ...
  drawBox(Box boxx, float r, float g, float b, float a, boolean fill)
  {
    ...
    GL11.glRotated(Floppa.MC.player.pitch, 1.d, 0.d, 0.d);
    GL11.glRotated((double) Floppa.MC.player.yaw + 180, 0.d, 1.d, 0.d);
  ...
  drawLine(double x1, double y1, double z1, double x2, double y2, double z2, float r, float g, float b, float a, float thicc)
  {
    ...
    GL11.glRotated(Floppa.MC.player.pitch, 1.d, 0.d, 0.d);
    GL11.glRotated(Floppa.MC.player.yaw + 180, 0.d, 1.d, 0.d);
  ...
  getCamPos()
  {
    return Floppa.MC.gameRenderer.getCamera().getPos();
  }
